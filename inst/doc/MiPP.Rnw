...
\begin{verbatim}
out <- mipp.seq(x=x.train, y=y.train, x.test=x.test, y.test=y.test, rule="lda", n.seq=3)
\end{verbatim}
...
All the other arguments in the \Rfunction{mipp.seq} function can also used in the \Rfunction{mipp.seq} function.
